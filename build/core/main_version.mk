...
PRODUCT_BUILD := $(PRODUCT_VERSION)-v$(PRODUCT_VERSION)-$(shell date +%Y%m%d)-$(RENOUVEAU_BUILD)-$(RENOUVEAU_BUILDTYPE)
else
PRODUCT_BUILD := $(PRODUCT_VERSION)-v$(PRODUCT_VERSION)-$(shell date +%Y%m%d)-$(RENOUVEAU_BUILD)-Unofficial
endif
